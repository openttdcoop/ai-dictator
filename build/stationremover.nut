...
if (stationid == null)
	{
	DInfo("Nothing to do, null stationid gave",1);
	return;
	}
...
if (exist)
	...
	INSTANCE.main.carrier.VehicleGroupSendToDepotAndWaitSell(uid);
...
if (exist)
	{
	if (!INSTANCE.main.builder.DeleteDepot(temp.depot))	{ DInfo("Fail to remove depot link to station "+wasnamed,1); }
